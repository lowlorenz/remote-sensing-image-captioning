...
srun python main.py --debug --max_cycles 3 --epochs 1 --batch_size 12 --sample_method confidence --data_path ../../../../../../scratch/lhlw --device_type cuda --num_nodes 1 --num_devices 2 --run_name debug
