#!/bin/bash
#SBATCH -J w_m_0
#SBATCH -o /home/users/w/wallburg/activelearning_ic/logs/word_margin_0.log
...
srun python main.py --batch_size 12 --max_cycles 9 --epochs 10 --run_name word_margin_0 --sample_method confidence --conf_mode margin --conf_average word --seed 0
